...
class EmailService {
  ...
  async sendBookingConfirmation(email, bookingDetails) {
    ...
    try {
      const subject = 'Booking Confirmed & Payment Successful - Home Services';
      const html = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
          <div style="background: #4f46e5; color: white; padding: 30px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px;">🏠 Home Services</h1>
          ...
          <div style="background: #f3f4f6; padding: 20px; text-align: center;">
            <p style="margin: 0; color: #6b7280; font-size: 14px;">Contact: abinandhan167@gmail.com</p>
          </div>
        </div>
      `;
  ...
  async sendPaymentConfirmation(email, paymentDetails) {
    ...
    const subject = 'Payment Confirmation - Home Services';
    const html = `
  ...
  async sendRegistrationConfirmation(email, userDetails) {
    ...
    const subject = 'Welcome to Home Services - Account Created Successfully!';
    const html = `
      ...
      <p>Best regards,<br>Home Services Team</p>
    `;
