...
// Map service names to local images in public/images/
const LOCAL_IMAGES = {
  'House Cleaning': '/images/House Cleaning.png',
  'Premium Home Cleaning': '/images/Premium Home Cleaning.png',
  'Carpet Cleaning': '/images/Carpet Cleaning.png',
  'Sofa Cleaning': '/images/Sofa Cleaning.png',
  'Moving Services': '/images/Moving Services.png',
  'AC Repair & Maintenance': '/images/AC Repair & Maintenance.png',
  'Painting': '/images/Painting Service.png',
  'Plumbing Repair': '/images/Plumbing.png',
  'Gardening': '/images/Gardening.png',
  'Kitchen Remodeling': '/images/Kitchen Remodeling.png',
  'Pool Maintenance': '/images/Pool Maintenance.png',
  'Pest Control': '/images/Pest Control.png',
  'CCTV Installation': '/images/CCTV Installation.png',
};

const getImage = (service) => LOCAL_IMAGES[service.name] || service.image;
